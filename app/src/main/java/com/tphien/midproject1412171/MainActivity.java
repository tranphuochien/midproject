...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( !manager.isProviderEnabled( LocationManager.GPS_PROVIDER ) ) {
            ServiceControler.buildAlertMessageNoGps(this);
        }
        else
            Global.setMode(true);
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            intent.putExtra("mStatusTextView", getString(R.string.google_status_fmt, user.getEmail()));
            intent.putExtra("mDetailTextView", getString(R.string.firebase_status_fmt, user.getUid()));
